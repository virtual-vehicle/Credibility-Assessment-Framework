...
describe("verifySystemStructure", () => {
    ...
    describe("well-defined structure", () => {
        ...
        it("everything well-defined => expect true", () => {
            ...
            const verification = metrics.verifySystemStructure(JSON.stringify(systemStructure));
        ...
        it("select input connector that does not require connection => expect true", () => {
            ...
            const verification = metrics.verifySystemStructure(JSON.stringify(systemStructure), JSON.stringify(notRequired));
