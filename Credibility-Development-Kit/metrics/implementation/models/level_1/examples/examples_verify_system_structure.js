...
// verify
const resultWell = metrics.verifySystemStructure(systemStructureWellDefined);
const resultType = metrics.verifySystemStructure(systemStructureTypeInconsistent);
const resultCut = metrics.verifySystemStructure(systemStructureConnectionCut);
const resultCutAddedArg = metrics.verifySystemStructure(systemStructureConnectionCut, inputNotRequired);
