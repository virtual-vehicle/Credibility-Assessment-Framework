 ...
 * @typedef {import('../check_opendrive_scenario_integration/src/types/types').t_road} t_road
 * @typedef {import('../check_opendrive_scenario_integration/src/types/types').t_road_planView} t_road_planView
 * @typedef {import('../check_opendrive_scenario_integration/src/types/types').t_junction} t_junction
