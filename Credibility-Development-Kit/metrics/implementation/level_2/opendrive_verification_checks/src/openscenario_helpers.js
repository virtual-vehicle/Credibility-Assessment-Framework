...
/**
 * @typedef {import('../check_opendrive_scenario_integration/src/types/types').MapLocation} MapLocation
 * @typedef {import('../check_opendrive_scenario_integration/src/types/types').OscParameterSet} OscParameterSet
 */
