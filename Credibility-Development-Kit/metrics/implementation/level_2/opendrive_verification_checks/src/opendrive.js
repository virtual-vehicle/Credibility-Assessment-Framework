...
/**
 * @typedef {import('../check_opendrive_scenario_integration/src/types/types').TargetObject} TargetObject
 * @typedef {import('../check_opendrive_scenario_integration/src/types/types').TargetSignal} TargetSignal
 * @typedef {import('../check_opendrive_scenario_integration/src/types/types').MapReference} MapReference
 * @typedef {import('../check_opendrive_scenario_integration/src/types/types').LineMarking} LineMarking
 * @typedef {import('../check_opendrive_scenario_integration/src/types/types').pose3d} pose3d
 * @typedef {import('../check_opendrive_scenario_integration/src/types/types').ResultLog} ResultLog
 */
