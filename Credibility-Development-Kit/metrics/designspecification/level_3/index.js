...
/**
 * Checks formally if a design specification is linked to assumptions and/or constraints
 * 
 * @author lvtan3005
...
/**
 * Checks if the linkage of a single design to assumptions and/or constriants makes sense from semantical point-of-view,
 * i.e., if the causal dependency of a design and its assumptions/constraints is comprehensible.
 * 
 * @author localhorst87
 * @license BSD-2-Clause
 * @kind function
