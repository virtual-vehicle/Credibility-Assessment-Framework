...
describe("isDocumentStructureValid", () => {
    ...
    it("valid structure => expect true", () => {
        let signedDoc = {
            "content": "arbitrary content",
            "signature": "00514ff050a656b624eb92338308702b",
            "hash_algorithm": "md5",
            "signature_encoding": "hex"
        };
        signedDoc = JSON.stringify(signedDoc);

        expect(helper.isDocumentStructureValid(signedDoc)).to.be.true;
    });

    it("no content property => expect false", () => {
        let signedDoc = {
            // "content": "arbitrary content",
            "signature": "00514ff050a656b624eb92338308702b",
            "hash_algorithm": "md5",
        ...
        expect(helper.isDocumentStructureValid(signedDoc)).to.be.false;
    });

    it("no signature property => expect false", () => {
        let signedDoc = {
            "content": "arbitrary content",
            // "signature": "00514ff050a656b624eb92338308702b",
            "hash_algorithm": "md5",
    ...
    it("no hash_algorithm property => expect false", () => {
        let signedDoc = {
            "content": "arbitrary content",
            "signature": "00514ff050a656b624eb92338308702b",
            // "hash_algorithm": "md5",
    ...
    it("no signature_encoding property => expect false", () => {
        let signedDoc = {
            "content": "arbitrary content",
            "signature": "00514ff050a656b624eb92338308702b",
            "hash_algorithm": "md5",
    ...
    it("signature too short => expect false", () => {
        let signedDoc = {
            "content": "arbitrary content",
            "signature": "00514ff050a656b6",
            "hash_algorithm": "md5",
            "signature_encoding": "hex"
        };
        signedDoc = JSON.stringify(signedDoc);
    ...
    it("not supported hash algo => expect false", () => {
        let signedDoc = {
            "content": "arbitrary content",
            "signature": "00514ff050a656b624eb92338308702b00514ff050a656b624eb92338308702b",
            "hash_algorithm": "sha1024",
            "signature_encoding": "hex"
        };
        signedDoc = JSON.stringify(signedDoc);
    ...
    it("not supported signature encodig => expect false", () => {
        let signedDoc = {
            "content": "arbitrary content",
            "signature": "00514ff050a656b624eb92338308702b",
            "hash_algorithm": "md5",
